...
parser.add_argument('--trained_model', default='weights/newssd300_COCO_395000.pth',
...
def test_voc():
    ...
    # load data
    testset = COCODetection(args.coco_root, 'minival2014', None, COCOAnnotationTransform)
    if args.cuda:
        net = net.cuda()
